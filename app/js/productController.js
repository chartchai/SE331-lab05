...
productMainController.controller('addProductController', addProductController);
...
productMainController.controller('listProductController', listProductController);
function listProductController($scope, $http, $rootScope, productService, $route, totalCalService) {
...
productMainController.controller('editProductController', editProductController);
